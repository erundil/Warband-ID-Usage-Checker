...
:start
echo off && cls && title ID Usage Checker is working...
::get start time
...
::display result
if %hh% equ 0 if %mm% equ 0 title ID Usage Checker have finished in: %ss%.%cc%s               && echo. && echo ========================================================================================================================
if %hh% equ 0 if %mm% gtr 0 title ID Usage Checker have finished in: %mm%min %ss%.%cc%s       && echo. && echo ========================================================================================================================
if %hh% gtr 0               title ID Usage Checker have finished in: %hh%h %mm%min %ss%.%cc%s && echo. && echo ========================================================================================================================
::restart variant
::echo. && echo Press any key to restart... && @echo off && pause>nul && goto :start
::exit variant
echo. && echo Press any key to exit... && @echo off && pause>nul