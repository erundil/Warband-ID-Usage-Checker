...
::display result
if %hh% equ 0 if %mm% equ 0 title Warband ID Usage Checker have finished in: %ss%.%cc%s               && echo. && echo ========================================================================================================================
if %hh% equ 0 if %mm% gtr 0 title Warband ID Usage Checker have finished in: %mm%min %ss%.%cc%s       && echo. && echo ========================================================================================================================
if %hh% gtr 0               title Warband ID Usage Checker have finished in: %hh%h %mm%min %ss%.%cc%s && echo. && echo ========================================================================================================================
::restart variant
